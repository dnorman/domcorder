...
async fn read_sample_frame_stream() {
    ...
    println!(
        "Reading TypeScript-generated frame stream ({} bytes)...",
        binary_data.len()
    );
    ...
    println!(
        "✓ Successfully parsed {} frames from TypeScript binary",
        parsed_frames.len()
    );
    ...
    println!(
        "🎉 All {} frames match expected values!",
        parsed_frames.len()
    );
}

#[tokio::test]
async fn read_sample_file() {
    ...
    println!(
        "Reading TypeScript-generated .dcrr file ({} bytes)...",
        binary_data.len()
    );
    ...
    println!(
        "✓ Read header: version={}, timestamp={}",
        header.version, header.created_at
    );
    ...
    println!(
        "✓ Successfully parsed {} frames from .dcrr file",
        parsed_frames.len()
    );
    ...
    println!(
        "🎉 All {} frames match expected values from .dcrr file!",
        parsed_frames.len()
    );
}

#[tokio::test]
async fn write_sample_frame_stream() {
    ...
    println!(
        "🎉 Successfully wrote and read back {} frames!",
        frames.len()
    );
}

#[tokio::test]
async fn write_sample_file_stream() {
    ...
    println!(
        "✓ Wrote .dcrr file with header + {} frames ({} bytes)",
        frames.len(),
        buffer.len()
    );
    ...
    println!(
        "🎉 Successfully wrote and read back .dcrr file with {} frames!",
        frames.len()
    );
}
